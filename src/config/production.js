module.exports = {
	...
	boot: {
		...
		session: {
			name: 'myapp.sid',
			secret: 'RZScBce4beIGWWhm5P1Y7U8f5LaomIiS',
			cookie: {
				maxAge: 604800000
			},
			resave: false,
	...
	middle: {
		basic: {
			enabled: true,
			user: 'myapp',
			pass: 'XxEeX9JOFATROos2pTJTkIxOyqIMaTzS'
		}
	},
	...
	api: {
		...
		token: {
			secret: 'X8LfgdQ5GCQ1XuHwLZJXZGqp38yum5z1',
			expires: 60
		},
		admin: {
			user: {
				...
				password: 'nlZCd7xEqnyvKiwyvllKBwUJBT1RYTUU',
				type: 'A'
			}
		}
	},
	...
	data: {
		...
		mongo: {
			...
			db: 'myapp',
			user: 'myapp',
			pass: 'TJutlQxolox6ByUVVdOiRxiGMgFnj7ZV',
			pool: 10,
			autoIndex: true,
			debug: true
		},
		redis: {
			host: '127.0.0.1',
			port: 6379,
			pass: 'ccv4YoeC2m5KLdFbB8CTOktrijiFOA8e'
		},
		solr: {
			enabled: false,
			host: 'localhost',
